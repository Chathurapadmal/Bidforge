  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="block h-0.5 w-40 bg-blue-500 mt-2 rounded mx-auto mb-3"></span>

        <p className="text-xl leading-relaxed max-w-5xl mx-auto text-gray-700">
      ...
      <div className="h-0.5 bg-blue-200 rounded my-14"></div>
      ...
      >
        ...
        >
          ...
          <span className="block h-1 w-60 bg-blue-500 rounded mx-auto mb-5"></span>
      ...
      {/* --- Footer --- */}
      <footer className="bg-gray-100 text-gray-800 py-6 text-center font-semibold tracking-wide">
