...
function BuyPage() {
    const { data, error, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])(// call relative URL so Next rewrites to backend
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$Config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_BASE"] + "/api/auctions?sort=latest&limit=100", fetcher);
    if (isLoading) {
...
//# sourceMappingURL=src_d075c2fd._.js.map