...
function LoginPage() {
    ...
    async function onSubmit(e) {
        ...
        setPending(true);
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetcher$2e$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiFetchClient"])("/api/auth/login", {
                method: "POST",
                body: JSON.stringify({
                    email,
                    password
...
//# sourceMappingURL=src_48d48b79._.js.map