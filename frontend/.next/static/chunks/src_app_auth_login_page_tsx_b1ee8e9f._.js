...
function LoginPage() {
    _s();
    const { login } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSession"])();
    ...
    const onSubmit = async (e)=>{
        ...
        try {
            ...
            var _e_message;
            setErr((_e_message = e === null || e === void 0 ? void 0 : e.message) !== null && _e_message !== void 0 ? _e_message : "Login failed");
        } finally{
            setBusy(false);
        }
    };
...
_s(LoginPage, "N5xQNR2CVPQU7uJCK3kAZX0bm4Q=", false, function() {
    return [
